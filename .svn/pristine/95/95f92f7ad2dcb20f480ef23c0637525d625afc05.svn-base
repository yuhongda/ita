...
public partial class Management_Works_upload : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ms = new MemoryStream();
            original_image.Save(ms, System.Drawing.Imaging.ImageFormat.Jpeg);

            // Store the data in my custom Thumbnail object
            string thumbnail_id = DateTime.Now.ToString("yyyyMMddHHmmssfff");
            Thumbnail thumb = new Thumbnail(jpeg_image_upload.FileName, jpeg_image_upload.FileName, ms.GetBuffer());
